...
[![Coverage Status](https://coveralls.io/repos/github/macbre/pelican-feed-planet/badge.svg?branch=master)](https://coveralls.io/github/macbre/pelican-feed-planet?branch=master)

This is a plugin for the [Pelican](https://getpelican.com) static site generator.
...
Write a [Jinja2](http://jinja.pocoo.org/) template for your aggregation page. For example, if the rest
...
[GNU Affero General Public License, either version 3 or any later version](https://www.gnu.org/licenses/agpl.html).
